...
//     beforeEach(async () => {
//         await browser.reloadSession(); // Reset session
//         await browser.url('https://www.dragonsteelbooks.com/'); // Navigate to the homepage
//     })
// })

// describe('cart side menu opens on all pages', async () => {
//     it.only('cart side menu opens and closes from cart icon on all pages', async () => {
